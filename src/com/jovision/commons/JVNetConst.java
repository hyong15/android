...
public final class JVNetConst {
    ...
    public final static byte JVN_ALARMCRY = 0x55;// 啼哭报警回调
    // 11新wifi配置结果
    public final static byte JVN_MOTION_DETECT_GET_CALLBACK = 17;// 获取移动侦测灵敏度回调
                                                                 // 2015.5.4
    public final static byte JVN_MOTION_DETECT_SET_CALLBACK = 18;// 设置移动侦测灵敏度回调
                                                                 // 2015.5.4
    ...
    public final static byte DECODETYPE = (byte) 0x12;
    public final static byte MOVESETTING = (byte) 0x16;
    public final static byte SAVEMANAGER = (byte) 0x13;
    public final static byte ALARMCRY = (byte) 0x23;
    public final static byte OVERTURN = (byte) 0x15;
    public final static byte OVERTURNIMG = (byte) 0x29;
    public final static byte EX_STORAGE_REFRESH = (byte) 0x01;
    public final static byte EX_STORAGE_REC_ON = (byte) 0x02; // sd卡开始录像
    public final static byte EX_STORAGE_REC_OFF = (byte) 0x03; // sd卡停止录像
    ...
    // 设置移动侦测灵敏度
    public final static int RC_EX_MDRGN = 0X06;

    public final static int EX_MDRGN_REFRESH = 0X01;
    public final static int EX_MDRGN_SUBMIT = 0X02;
    public final static int EX_MDRGN_UPDATE = 0X03;

    // 存储管理指令,lck20120306
    public final static int EX_STORAGE_REC = 0x02;
    public final static int EX_STORAGE_SWITCH = 0x07;

    // sd卡状态值枚举 2015.5.4
    public final static int STG_NONE = 0; // 未发现设备
    public final static int STG_NOFORMAT = 1; // 未格式化
    public final static int STG_FULL = 2; // 满了
    public final static int STG_USING = 3; // 使用中
    public final static int STG_IDLE = 4; // 空闲

    //
    // public final static int RC_EX_STORAGE = 0x03;
    // //存储管理指令,lck20120306
    // public final static int EX_STORAGE_REFRESH = 0x01;
    // public final static int EX_STORAGE_REC = 0x02;
    // public final static int EX_STORAGE_OK = 0x04;
    // public final static int EX_STORAGE_ERR = 0x05;
    // public final static int EX_STORAGE_FORMAT = 0x06;
    // public final static int EX_STORAGE_SWITCH = 0x07;
