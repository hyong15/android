...
public class JVDeviceConst {
    ...
    public static final String JK_AD_PIC_VER = "adpv";
    public static final String JK_AD_LINK_VER = "adlv";
    ...
    public static final String JK_WEB_SHARE_URL = "shareurl";
    public static final String JK_WEB_SHARE_FLAG = "sharef";
    public static final String JK_WEB_TOPIC_FLAG = "topf";
    public static final String JK_WEB_TOPIC_LIST = "topl";
    public static final String JK_WEB_TOPIC_DETAIL = "topd";
    ...
    // 手机端自助分享发布
    public static final int MEDIA_SHARE_CHECK = 5220;
    public static final int SM_SHARED = 28;// 分享
    public static final int SM_NOT_SHARED = 29;// 未分享
    public static final int VAS_NOT_SUPPORT_SHARE = 23;// 设备不支持分享
}
