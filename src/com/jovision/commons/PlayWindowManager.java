...
public class PlayWindowManager implements View.OnClickListener,
     ...
     * 单例获取管理实例
     * 
     * @param context 内容上下文，必须实现 {@link PlayWindowManager.OnUiListener}
     * @return
     */
    ...
    public interface OnUiListener {
         ...
         * 单个窗口的点击事件
         * 
         * @param channel 窗口所对应的通道
         * @param isFromImageView 判断是否来自图像视图
         * @param viewId 事件来自视图标识，参考 {@link PlayWindowManager#ID_CONTROL_CENTER}
         ...
         * 
         * @param index 对应窗口索引
         * @param status 当前生命周期状态，参考 {@link PlayWindowManager#STATUS_CREATED},
         *            {@link PlayWindowManager#STATUS_CHANGED},
         *            {@link PlayWindowManager#STATUS_DESTROYED}
         * @param surface 当前 Surface 对象
         * @param width 长
         * @param height 宽
         */
     ...
     * 之前调用方可生效
     * 
     * @param leftResId 左按钮图片资源标识
     * @param upResId 上按钮图片资源标识
     * @param rightResId 右按钮图片资源标识
     * @param bottomResId 下按钮图片资源标识
     */
     ...
     * 修改中间控制图片
     * 
     * @param container 包含中间控制按钮的容器视图
     * @param centerResId 待替换的图片资源标识
     */
     ...
     * 
     * @param container 包含中间提示文字的容器视图
     * @param viewId 控件标识，参考 {@link PlayWindowManager#ID_CONTROL_BOTTOM}，
     ...
     * @param visibility 显示性，参考 {@link View#VISIBLE}， {@link View#INVISIBLE}，
     *            {@link View#GONE}，
     */
     ...
     * 获取指定页面下指定窗口的通道
     * 
     * @param pageId 页面标识，从 0 开始
     * @param position 窗口标识，当前页面从 0 开始
     * @return 通道对象
     */
