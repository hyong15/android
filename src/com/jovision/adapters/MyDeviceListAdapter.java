        ...
        try {
            ...
            if (2 == deviceList.get(position * 2).getIsDevice()) {
                ...
                if (MySharedPreference.getBoolean(Consts.MORE_LITTLE)) {
                    deviceHolder.devNameL
                            .setText(deviceList.get(position * 2).getNickName()
                                    + "-"
                                    + deviceList.get(position * 2).getIp()
                                    + "-"
                                    + deviceList.get(position * 2)
                                            .getChannelBindFlag());
                }
                // + "-"
            ...
            if (Boolean
                ...
                if ("0".equals(((BaseActivity) context_).statusHashMap
                ...
                if (deviceList.get(position * 2).getCloudEnabled() == 1) {
                    Drawable draw_cloud_on = context_.getResources()
                            .getDrawable(R.drawable.cloud_state_on);
                    draw_cloud_on.setBounds(0, 0,
                            draw_cloud_on.getMinimumWidth(),
                            draw_cloud_on.getMinimumHeight());
                    deviceHolder.tv_dev_cloud_state_L.setCompoundDrawables(
                            draw_cloud_on, null, null, null);
                } else if (deviceList.get(position * 2).getCloudEnabled() == 0) {
                    Drawable draw_cloud_off = context_.getResources()
                            .getDrawable(R.drawable.cloud_state_off);
                    draw_cloud_off.setBounds(0, 0,
                            draw_cloud_off.getMinimumWidth(),
                            draw_cloud_off.getMinimumHeight());
                    deviceHolder.tv_dev_cloud_state_L.setCompoundDrawables(
                            draw_cloud_off, null, null, null);
                } else {
                    // 不显示
                    deviceHolder.tv_dev_cloud_state_L
                    ...
                    if (position * 2 + 1 < deviceList.size()) {
                        ...
                        if (deviceList.get(position * 2 + 1).getCloudEnabled() == 1) {
                            ...
                            draw_cloud_on.setBounds(0, 0,
                                    draw_cloud_on.getMinimumWidth(),
                                    draw_cloud_on.getMinimumHeight());
                            deviceHolder.tv_dev_cloud_state_R
                                    .setCompoundDrawables(draw_cloud_on, null,
                                            null, null);
                            ...
                            draw_cloud_off.setBounds(0, 0,
                                    ...
                                    draw_cloud_off.getMinimumHeight());
                            deviceHolder.tv_dev_cloud_state_R
                                    .setCompoundDrawables(draw_cloud_off, null,
                                            null, null);
                        } else {
                            // 不显示
                            deviceHolder.tv_dev_cloud_state_R
