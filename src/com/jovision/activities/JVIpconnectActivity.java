...
public class JVIpconnectActivity extends BaseActivity {
    ...
    protected void initUi() {
        ...
        if (isDevice == 0) {
            ...
            cloudText.setTextColor(getResources()
            ...
            isTurn = true;
            ipText.setTextColor(getResources().getColor(R.color.welcome_blue));
                    ...
                    if (2 == isDevice) {
                        ...
                        ani2.setAnimationListener(new AnimationListener() {
                            ...
                            public void onAnimationEnd(Animation animation) {
                                ...
                                mContainer.startAnimation(AnimationUtils
