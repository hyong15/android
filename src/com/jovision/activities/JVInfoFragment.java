...
public class JVInfoFragment extends BaseFragment  implements OnMainListener{
	public boolean flag; //HYONG 是否显示左箭头标识 ，true不显示
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //HYONG 下面四行
        Button btn_left = (Button) rootView.findViewById(R.id.btn_left);
        if(flag){
