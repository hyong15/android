        ...
        try {
            ...
            switch (what) {
                ...
                case Consts.WHAT_MANAGE_ITEM_CLICK: {// adapter item 单击事件
                    JVDeviceManageFragment.clickIndex = arg1;
                    ...
                    switch (arg1) {
                        ...
                        case 2: {// 连接模式
                            ...
                            // mActivity.showTextToast(R.string.ip_add_notallow);
                            // } else {
                            Intent intent = new Intent(mActivity, JVIpconnectActivity.class);
                        ...
                        case 4: {// 立即观看
                            // if (0 ==
                            // deviceList.get(deviceIndex).getOnlineState()
                            // && !Boolean
                        ...
                        case 5: {// 一键升级
                            if (2 == device.getDeviceType()) {// 家用
                            ...
                            } else {// 非家用，直接连接设备，判断是否ipc，获取设备型号
                                StatService.trackCustomEvent(
                                        mActivity,
                                        "DeviceUpdate",
                                        mActivity.getResources().getString(
                                ...
                                // Intent deviceIntent = new Intent(mActivity,
                                // JVDeviceUpdateCloudSeeActivity.class);
                                // deviceIntent.putExtra("deviceIndex",
                                // deviceIndex);
                                // startActivity(deviceIntent);
                                startTimer();
                                mActivity.createDialog("", false);
                ...
                case Consts.CALL_TEXT_DATA: {// 文本回调
                    ...
                    switch (arg2) {
                        case JVNetConst.JVN_RSP_TEXTACCEPT:// 同意文本聊天
                            ...
                            if (0 == JVDeviceManageFragment.clickIndex) {
                                // 获取基本文本信息
                                Jni.sendTextData(1, JVNetConst.JVN_RSP_TEXTDATA, 8,
                                        JVNetConst.JVN_REMOTE_SETTING);
                            } else if (5 == JVDeviceManageFragment.clickIndex) {
                                // 获取主控码流信息请求
                                Jni.sendTextData(1, JVNetConst.JVN_RSP_TEXTDATA, 8,
                        ...
                        case JVNetConst.JVN_RSP_TEXTDATA:// 文本数据
                            ...
                            try {
                                ...
                                // 远程配置请求，获取到配置文本数据
                                    ...
                                    case JVNetConst.JVN_WIFI_INFO:// 2--
                                                                  // AP,WIFI热点请求
                                        // 获取主控码流信息请求
                                        Jni.sendTextData(1, JVNetConst.JVN_RSP_TEXTDATA, 8,
                                                JVNetConst.JVN_STREAM_INFO);
                                        break;
                                    case JVNetConst.JVN_STREAM_INFO:// 3--
                                                                    // 码流配置请求
                                        ...
                                        if (null != streamMap) {
                                            if (null != streamMap.get("ProductType")
                                                    && !"".equalsIgnoreCase(streamMap
                                                            .get("ProductType"))) {
                                                productType = streamMap.get("ProductType");
                                            }

                                            if (null != streamMap.get("Version")
                                                    && !"".equalsIgnoreCase(streamMap
                                                            .get("Version"))) {
                                                String temp = streamMap.get("Version");
                                        ...
                                        deviceIntent.putExtra("deviceIndex",
                                                JVDeviceManageFragment.deviceIndex);
                                        deviceIntent.putExtra("productType", productType);
                                        deviceIntent.putExtra("version", version);
                                        startActivity(deviceIntent);
                                        PlayUtil.disconnectDevice();
                                        break;
