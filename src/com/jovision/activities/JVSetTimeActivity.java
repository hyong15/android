...
public class JVSetTimeActivity extends BaseActivity {
    ...
    protected void initUi() {
        ...
        currentMenu
                .setText(getResources().getString(R.string.str_setting_time));
        ...
        rightBtn.setText(getResources().getString(R.string.str_finish));
        reParamstop2 = new RelativeLayout.LayoutParams(width / 5,
            ...
            switch (v.getId()) {
                ...
                case R.id.intenttime:
                    ...
                    if (!isopen) {
                        ...
                        dateTypeGone.setVisibility(View.GONE);
                        timeTypeGone.setVisibility(View.GONE);
                        Jni.sendString(window, JVNetConst.JVN_RSP_TEXTDATA, false,
                ...
                case R.id.date_type:
                    isdatetype = 1;
                    popupWindow = new TimePopView(JVSetTimeActivity.this,
                            myOnClickListener, isdatetype);
                ...
                case R.id.save:
                    if (0 == isdatetype) {
                        ...
                        if (-1 != MySharedPreference.getInt("year")) {
                            ...
                            sb.append(
                                    MySharedPreference.getInt("year") + START_YEAR)
                                    .append("-")
                                    .append(MySharedPreference.getInt("month") + 1)
                                    .append("-")
                                    .append(MySharedPreference.getInt("day") + 1)
                                    .append(" ")
                                    .append(MySharedPreference.getInt("hour"))
                                    .append(":")
                                    .append(MySharedPreference.getInt("mins"))
                                    .append(":").append("00");
                            // if (1 == MySharedPreference.getInt("timetype")) {
                            //
                            // } else if (2 ==
    ...
    private void Savetime() {
        ...
        Jni.sendSuperBytes(window, JVNetConst.JVN_RSP_TEXTDATA, false,
        ...
        showTextToast(getResources().getString(
                R.string.str_setting_time_success));
    }
