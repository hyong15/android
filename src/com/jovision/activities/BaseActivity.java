...
public abstract class BaseActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 放大左右侧箭头的点击区域
        if (leftBtn != null) {
            CommonUtil.expandViewTouchDelegate(leftBtn,
                    CommonUtil.dp2px(this, 50));
        }
        // if (null != alarmnet) {
...
// "/test.mp4");
// Bitmap bitmap = retriever.getFrameAtTime(playVideoView.getCurrentPosition() *
// 1000,
// MediaMetadataRetriever.OPTION_CLOSEST_SYNC);
//
// ImageUtil.saveBitmap(Consts.CAPTURE_PATH, bitmap, "aaaaaaaa.jpg");
