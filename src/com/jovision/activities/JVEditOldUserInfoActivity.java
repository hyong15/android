    ...
    OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.finish:
                    userNameEditText = (EditText) findViewById(R.id.registusername);
                    // pass1EditText = (EditText)
                    // findViewById(R.id.registpass1);
                    // pass2EditText = (EditText)
                    // findViewById(R.id.registpass2);
    ...
    class EditTask extends AsyncTask<String, Integer, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            try {
                ...
                // .toString());
                resetRes = AccountUtil.isUserExsitV2(userNameEditText.getText()
                        .toString());
                if (JVAccountConst.USER_HAS_EXIST != nameExists
