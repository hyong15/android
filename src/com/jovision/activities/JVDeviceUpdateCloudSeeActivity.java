...
public class JVDeviceUpdateCloudSeeActivity extends BaseActivity {
                                    ...
                                    switch (extend_type) {
                                        ...
                                        case Consts.EX_UPLOAD_CANCEL: {// 2-取消发送升级命令
                                            ...
                                            Jni.sendSuperBytes(1, JVNetConst.JVN_RSP_TEXTDATA,
                                                    ...
                                                    0, 0, null, 0);
                                            dismissDialog();
                                            if (2 == deviceList.get(devIndex).getDeviceType()) {// 家用IPC
                                        ...
                                        case Consts.EX_FIRMUP_RET: {
                                            ...
                                            if (Consts.FIRMUP_SUCCESS == pro) {

                                            } else if (Consts.FIRMUP_FAILED == pro) {
                                            ...
                                            } else if (Consts.FIRMUP_LATEST == pro) {
                                                JVDeviceUpdateCloudSeeActivity.this
    ...
    protected void initSettings() {
        ...
        if (2 != deviceList.get(devIndex).getDeviceType()) {// 家用设备
    ...
    protected void initUi() {
        ...
        versionInfoLayout = (LinearLayout) findViewById(R.id.versioninfo);
        ...
        if (2 == deviceList.get(devIndex).getDeviceType()) {// 家用设备
            ...
            devModel.setText(productType);
            devVersion.setText(version);
        }
            ...
            switch (view.getId()) {
                ...
                case R.id.update: {// 一键升级
                    if (2 == deviceList.get(devIndex).getDeviceType()) {// 家用IPC
                        ...
                        createDialog("", false);
                        showConnectRes = true;
                        PlayUtil.connectDevice(deviceList.get(devIndex));
                    }
    ...
    public void hasUpdateDialog() {
        AlertDialog ad = new AlertDialog.Builder(
                ...
                .setMessage(
                        getResources().getString(R.string.device_new_version)
                                + updateObj.getUfver())
                .setCancelable(false)
    ...
    private void createDownloadProDialog(int max) {
        ...
        if (updateDialog == null) {
            updateDialog = new ProgressDialog(
                    JVDeviceUpdateCloudSeeActivity.this);
            updateDialog.setCancelable(false);
            updateDialog.setIcon(R.drawable.download);
            updateDialog.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
            updateDialog.setTitle(getResources().getString(
