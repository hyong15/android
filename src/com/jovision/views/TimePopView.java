...
public class TimePopView extends PopupWindow {
    ...
    public TimePopView(Activity context, OnClickListener itemsOnClick, int type) {
        ...
        if (0 == type) {
            ...
            pop_outside = (RelativeLayout) mMenuView
                    .findViewById(R.id.pop_outside);
            timePicker1 = (LinearLayout) mMenuView
            ...
            save = (TextView) mMenuView.findViewById(R.id.save);
            quit = (TextView) mMenuView.findViewById(R.id.quit);
            relativeOne = (RelativeLayout) mMenuView
                    .findViewById(R.id.relativeone);
            relativeTwo = (RelativeLayout) mMenuView
                    .findViewById(R.id.relativetwo);
            relativeThree = (RelativeLayout) mMenuView
                    .findViewById(R.id.relativethree);
            relativeOne_img = (ImageView) mMenuView
                    .findViewById(R.id.relativeone_img);
            relativeTwo_img = (ImageView) mMenuView
                    .findViewById(R.id.relativetwo_img);
            relativeThree_img = (ImageView) mMenuView
                    .findViewById(R.id.relativethree_img);
