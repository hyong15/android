 ...
 * 
 * @author Administrator FixedSpeedScroller scroller = new
 *         FixedSpeedScroller(context,new AccelerateInterpolator());
 */
public class ImageScroller extends Scroller {
    ...
    public ImageScroller(Context context, Interpolator interpolator) {
